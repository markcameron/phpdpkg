<?php namespace Phpdpkg\Helper;

use Herrera\Json\Json;
use Phpdpkg\Configuration;
 ...
 * @var string
 */
define('PHPDPKG_SCHEMA_FILE', BASE_PATH . '/res/schema.json');
...
class ConfigurationHelper extends Helper {
  ...
  public function loadFile($file = null) {
    ...
    $this->json->validate(
      $this->json->decodeFile(PHPDPKG_SCHEMA_FILE),
      $json
    );
